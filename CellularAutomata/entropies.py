...
'''
Credits and thanks to Antunes, L. M. (2021). Functions adapted from
CellPyLib: A Python Library for working with Cellular Automata. Journal of Open Source Software, 6(67), 3608.
'''

def shannon_entropy(string):
    """
    Calculates the Shannon entropy for a string of characters.
